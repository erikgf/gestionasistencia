...
app.agregar = function(){
  _ACCION = "agregar";
  _TEMPID = -1;
  this.DOM.mdlHeader.html((_ACCION+" Tipo de Problema").toUpperCase());
};
...
app.editar = function(cod){
  ...
  DOM.mdlHeader.html((_ACCION+" Tipo de Problema").toUpperCase());
  new Ajxur.Api({
    modelo: _CLASE,
    metodo: "leerDatos",
    data_in : {
      p_codTipoProblema: cod
    }
  },fn);
};
